...
public class ReportingFilter implements Filter {
    ...
    String requestParams =
        "----   REQUEST ----  \nRequest method:\t"
            ...
            + "\nRequest params:\t"
            + formatMap(requestSpec.getRequestParams())
            + "\nForm params:\t"
            + formatMap(requestSpec.getFormParams())
            + "\nPath params:\t"
            + formatMap(requestSpec.getPathParams())
            + "\nHeaders:\t\t"
            + formatHeaders(requestSpec.getHeaders())
            + "\n--------------------------------------------------------------------------------------\nCookies:\t\t"
            + formatCookies(requestSpec.getCookies())
            + "\nMultiparts:\t\t"
            + formatMultiPartParams(requestSpec.getMultiPartParams())
            + "\n--------------------------------------------------------------------------------------\nRequest Body: ";
